...
class CustomPackage(models.Model):
    ...
    _name = "syscraft.clinic.financials.custom.package.tbl"
    _inherit = "mail.thread"
    _description = "Custom Package records"
    ...
    bill_item_ids = fields.One2many('syscraft.bill.items.tbl', 'package_id', string="Bill Items")
...
class BillItems(models.Model):
    _name = "syscraft.bill.items.tbl"
    _description = "Bill Items"
    ...
    package_id = fields.Many2one('syscraft.clinic.financials.custom.package.tbl')
