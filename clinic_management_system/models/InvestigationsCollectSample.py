...
class InvestigationsCollectSample(models.Model):
    # defines the table name inside the database
    _name = "syscraft.clinic.investigations.collect.sample.tbl"
    _inherit = "mail.thread"
    _description = "Invesigations Collect Sample records"
