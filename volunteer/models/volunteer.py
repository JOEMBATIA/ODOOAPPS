...
class Volunteer(models.Model):
    ...
    # Method to check if the given country is an african country
    ...
    # Restricts the volunteer from entering the wrong dates for volunteering
    ...
    # Method to automatically calculate the volunteers age
        ...
        for vals in vals_list:
            ...
            if vals.get('country_id'):
                ...
                if country.code in self.AFRICAN_COUNTRIES:
                    ...
                    vals[
                        'rejection_reason'] = 'Application automatically rejected due to geographical restrictions. The volunteer comes from ' + country.name
                else:
    ...
    def action_approve(self):
        ...
        template = self.env.ref('volunteer.volunteer_approval_email_template')
    ...
    def action_send_certification_mail(self):
        # Load the email template
        template = self.env.ref('volunteer.volunteer_completion_certificate_email_template')
